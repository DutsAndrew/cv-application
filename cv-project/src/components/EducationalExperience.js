    ...
    return (
      <div id='educational-experience'>
        ...
        <form id="cv-education">
          ...
          <input type='text' id="school-input" className='educational-exp' placeholder={educationalExperience.schoolName} onChange={handleChange} ></input>
          <label className='education-degree'>Degree Name:</label>
          <input type='text' id="degree-input" className='educational-exp' placeholder={educationalExperience.degree} onChange={handleChange} ></input>
          <label className='education-start-studies'>Start of Studies:</label>
          <input type='date' id="start-studies-input" className='educational-exp' placeholder={educationalExperience.startDate} onChange={handleChange} ></input>
          <label className='education-end-studies'>End of Studies:</label>
          <input type='date' id="end-studies-input" className='educational-exp' placeholder={educationalExperience.endDate} onChange={handleChange} ></input>
        </form>
